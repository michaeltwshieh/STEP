...
1. substantive rule;
2. constitution/capacity;
3. decision-maker/procedure;
4. duties/liability;
5. records/filings;
6. documents; and
7. consequences/remedies.
...
- transaction stage and regime;
- every operative part and selectable alternative;
- every incorporated attachment/exhibit and the complete attachments set; and
...
produced draft. A corporate actor's upstream authority is a separate instrument; a
generic signatory recital is not a substitute. A notice must reproduce the applicable
operative business it asks the meeting to decide, not merely its first resolution.
For embedded meeting business, count the action precedent's operative resolutions one
by one and show the expected/actual count; a broad first resolution cannot stand in for
separate appointment, authority, remuneration, audit or completion decisions.
...
Cross-checked: <the shared routing-core second-pass result — any other module/appendix checked for a multi-module overlap and the verdict, e.g. "Module 10 §5.8 → incorporated; Module 12 → considered, not relevant"; or "single-module". Always present, even when empty-handed.>
